  ...
  <div class="relative min-w-0 max-w-full">
    ...
    <template v-if="isAdmin">
      ...
      >
        ...
        ></span>
        <!-- Update indicator -->
        <span v-if="hasUpdate" class="relative flex h-2 w-2 shrink-0">
          <span
    ...
    <span
      ...
      class="block min-w-0 max-w-full truncate text-xs text-gray-500 dark:text-dark-400"
      :title="versionLabel"
    >
      {{ versionLabel }}
    </span>
...
const versionLabel = computed(() => formatVersionLabel(props.version))
