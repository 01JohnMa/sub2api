<template>
  <header class="glass sticky top-0 z-30 border-b border-accent-200/80 dark:border-dark-700/80">
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="hidden lg:block">
          <h1 class="text-lg font-semibold text-accent-950 dark:text-white">
            {{ pageTitle }}
          </h1>
          <p v-if="pageDescription" class="text-xs text-accent-600 dark:text-dark-400">
            {{ pageDescription }}
          </p>
        </div>
      </div>
      ...
      <div class="flex items-center gap-3">
        ...
        <a
          ...
          class="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-accent-700 transition-colors hover:bg-primary-50 hover:text-primary-800 dark:text-dark-400 dark:hover:bg-dark-800 dark:hover:text-white"
        >
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-lg border border-primary-200 bg-primary-50 px-3 py-1.5 dark:border-primary-800 dark:bg-primary-900/20 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-lg bg-primary-700 text-sm font-medium text-white shadow-sm dark:bg-primary-500 dark:text-dark-950">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
            ...
            <div class="hidden text-left md:block">
              <div class="text-sm font-medium text-accent-950 dark:text-white">
                {{ displayName }}
              </div>
              <div class="text-xs capitalize text-accent-600 dark:text-dark-400">
                {{ user.role }}
              </div>
            </div>
