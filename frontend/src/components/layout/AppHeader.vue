    ...
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <a
          ...
          class="hidden items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-accent-700 transition-colors hover:bg-primary-50 hover:text-primary-800 dark:text-dark-400 dark:hover:bg-dark-800 dark:hover:text-white sm:flex"
        >
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            ...
            <div class="hidden text-left md:block">
              ...
              <div class="text-xs text-accent-600 dark:text-dark-400">
