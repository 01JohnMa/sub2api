...
| Candidate commit/image | Embedded commit `bfc38893c490bfdf7b58bc6127cca68a65f65a93`; local linux/amd64 `coocode-sub2api:p0b-bfc3889`, image ID `sha256:d5f5a5faea0e301b4e5f0a1d917393bb4e921d6f14923cf17019aa03cb9eb726`; embedded version `ui-phase2-p0b-bfc3889`, build time `2026-07-22T08:10:03Z` |
| Candidate health URL/result | Loopback `http://127.0.0.1:18080/health` -> `{"status":"ok"}`; application, disposable PostgreSQL, and disposable Redis all healthy with restart count `0`; only the application was recreated, while PostgreSQL/Redis retained their `2026-07-22T04:38:43Z` starts |
